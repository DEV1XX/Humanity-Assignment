      ...
      return (
        <div className="border border-blue-500 rounded-lg p-6">
          ...
          <div className="flex mb-6">
            <button 
              className={`py-2 px-6 text-sm rounded-md ${activeSection === "promoterSettings" ? "bg-blue-100 text-blue-600" : "bg-gray-50 text-gray-600"}`}
              onClick={() => handleSectionChange("promoterSettings")}
            >
              Promoter Settings
            </button>
            <button 
              className={`py-2 px-6 text-sm rounded-md ml-2 ${activeSection === "leadsSettings" ? "bg-blue-100 text-blue-600" : "bg-gray-50 text-gray-600"}`}
                  ...
                  <div key={index} className="mb-3 last:mb-0">
                    {step.type === "wait" ? (
                      <div className="flex items-center bg-white rounded-md p-2 pl-4">
                        ...
                        <span className="text-sm">Wait {step.days} days</span>
                      </div>
                    ) : step.type === "email" ? (
          ...
          <div>
            ...
            <div className="border border-gray-200 rounded-md">
              <div className="flex border-b border-gray-200 p-2">
                <button className="text-sm px-3 py-1 font-medium">Chat with AI</button>
                <button className="text-sm px-3 py-1 font-medium">My Leads</button>
                <button className="text-sm px-3 py-1 font-medium">My Rewards</button>
              ...
              <div className="p-4 bg-gray-50">
                <div className="text-center p-4">
                  <h2 className="text-lg font-medium mb-1">Welcome back! You're promoting:</h2>
                  <h3 className="text-lg font-semibold mb-3">SnackNation Express</h3>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {activeTab !== "pastPromoters" && (
          <div className="flex items-center">
            ...
            <span className="text-sm text-gray-500 mr-4">Draft</span>
            <img 
              src="/api/placeholder/32/32" 
              alt="User avatar" 
              className="w-8 h-8 rounded-full mr-2"
            />
            <span className="text-sm font-medium">Kevin Stanton</span>
            <span className="text-xs text-gray-500 ml-1">Product Manager</span>
          </div>
        )}
      </div>
